...
insert  into `barang`(`kodebarang`,`namabarang`,`Stok`,`HargaStandard`) values ('G001','ABG Umur 15',9,1000000),('G002','Tante Girang',2,500000),('G003','Alay',5,10000);
...
insert  into `faktur`(`NomorFaktur`,`KodePelanggan`,`TanggalFaktur`) values ('F0213','G01','2013-01-30'),('F0214','G01','2013-01-30'),('F0215','G01','2013-01-31'),('F0216','G01','2013-01-31');
...
insert  into `fakturdetail`(`id`,`NomorFaktur`,`KodeBarang`,`Qty`,`Harga`) values (10,'F0213','G001',1,1000000),(11,'F0214','G001',3,1000000),(12,'F0215','G002',1,500000),(13,'F0215','G001',2,1000000),(14,'F0216','G001',1,1000000);
...
insert  into `kwitansi`(`NomorKwitansi`,`TanggalKwitansi`,`NomorFaktur`) values ('K0001','2013-01-31','F0215'),('K0002','2013-01-31','F0213'),('K0003','2013-02-01','F0216'),('K0004','2013-02-01','F0214');
